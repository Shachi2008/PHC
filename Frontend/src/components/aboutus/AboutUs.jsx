                    ...
                    <div className="flex flex-col md:flex-row items-center md:space-x-2 md:mb-[70px] mb-7">
                        ...
                        <div className="order-2 md:order-1 md:w-1/2 ">
                            <div className="lg:max-w-md max-w-[320px] text-center md:text-left mx-auto md:mx-0">
                                ...
                                <p className="text-gray-600 lg:text-[18px] text-[15px] max-w-[370px] leading-relaxed">Welcome to The Prestige Hotel Concierge, the top destination for customised premium vacation experiences. We specialise in connecting discerning travellers with the best hotels, exclusive services, and unforgettable excursions throughout the world. Our objective is to make every experience unforgettable by delivering luxury service and unequalled access to the best that luxury travel has to offer.
                                </p>
                    ...
                    <div className="flex flex-col md:flex-row items-center md:space-x-2 md:pb-[70px] pb-7 pt-4">
                        ...
                        <div className="order-2 md:w-1/2 lg:max-w-[350px] max-w-[340px]">
                            <div className="lg:max-w-lg max-w-[350px] text-center md:text-left md:mx-0">
                                ...
                                <p className="text-gray-600 lg:text-[18px] text-[15px]  leading-relaxed">The Prestige Hotel Concierge believes that travel should be more than just a trip,  it should be an unforgettable experience. Our mission is to turn ordinary travel into amazing experiences by providing personalised services, special bargains, and a simple booking process.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center md:space-x-2">
                        ...
                        <div className="order-2 md:order-1 md:w-1/2">
                            <div className="lg:max-w-md max-w-[300px] text-center md:text-left mx-auto md:mx-0 ">
                                ...
                                <p className="text-gray-600 lg:text-[18px] text-[15px] max-w-[370px] leading-relaxed">The Prestige Hotel Concierge is more than simply a travel booking website; we are your partners in making wonderful memories. Join us on a journey to discover the world's most compelling destinations and feel the true spirit of luxury travel.</p>
                            </div>
                        </div>
                    </div>
