...
export default function ContactSection() {
  ...
  const onSubmit = async (event) => {
    ...
    const recipientEmail = "contact@prestigehotelconcierge.com";
    ...
    try {
      const response = await fetch(
        `{${base_url}/send-email}/${encodeURIComponent(
          recipientEmail
        )}`,
        {
          method: "POST",
      ...
      <div className="max-w-6xl mx-auto md:px-4">
        <div className="md:flex ">
          <div className="md:w-2/5 md:mt-10 md:pr-[5rem] mx-3">
            ...
            <a href="mailto:contact@prestigehotelconcierge.com">
              {" "}
              <div className="md:mt-[5rem] cursor-pointer my-1 text-gray-500">
                Email: contact@prestigehotelconcierge.com
              </div>
            </a>
            ...
            <div className="text-gray-500 flex items-center md:gap-4 gap-2 text-xl md:text-2xl">
              <a
                href="https://www.facebook.com/profile.php?id=61562328525447&mibextid"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/prestigehotelconcierge/"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://www.instagram.com/prestigehotelconcierge?igsh=MzRlODBiNWFlZA=="
                target="_blank"
                rel="noopener noreferrer"
              >
